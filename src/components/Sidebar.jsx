            ...
            {folderOptions.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={label==="Overdue" ? "w-full text-red-500 text-left px-6 py-4 text-lg md:text-2xl font-semibold relative cursor-pointer" : "w-full text-left px-6 py-4 text-lg md:text-2xl font-semibold relative cursor-pointer"}
                >
                  <span
                    className={[
